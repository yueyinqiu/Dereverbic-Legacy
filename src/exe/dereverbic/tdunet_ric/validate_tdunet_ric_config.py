...
from exe.dereverbic.tdunet_ric import train_tdunet_ric_config as _train_ricbe_ric_config


device: _torch.device = \
    _train_ricbe_ric_config.device


checkpoints_directory: _pathlib.Path = \
    _train_ricbe_ric_config.checkpoints_directory
