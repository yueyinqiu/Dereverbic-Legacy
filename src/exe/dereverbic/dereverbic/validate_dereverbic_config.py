...
from exe.dereverbic.dereverbic import train_dereverbic_config as _train_ricbe_full_config


device: _torch.device = \
    _train_ricbe_full_config.device


checkpoints_directory: _pathlib.Path = \
    _train_ricbe_full_config.checkpoints_directory
