...
def test(model: TdunetRicModelWithoutEnergyDecay, 
...
def main():
    from exe.dereverbic.tdunet_ric_without_energy_decay import test_tdunet_ric_without_energy_decay_config as config

    print("# Loading...")
    test(TdunetRicModelWithoutEnergyDecay(config.device), 
