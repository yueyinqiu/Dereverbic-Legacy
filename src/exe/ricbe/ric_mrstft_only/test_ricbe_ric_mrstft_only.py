...
from models.ricbe_models.ricbe_ric_model_mrstft_only import RicbeRicModelMrstftOnly
from trainers.trainer import Trainer


def test(model: RicbeRicModelMrstftOnly, 
...
def main():
    from exe.ricbe.ric_mrstft_only import test_ricbe_ric_mrstft_only_config as config

    print("# Loading...")
    test(RicbeRicModelMrstftOnly(config.device), 
