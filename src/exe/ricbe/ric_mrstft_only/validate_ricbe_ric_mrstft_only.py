...
def main():
    from exe.ricbe.ric_mrstft_only import validate_ricbe_ric_mrstft_only_config as config
    ...
    model: RicbeRicModelMrstftOnly = RicbeRicModelMrstftOnly(config.device)
